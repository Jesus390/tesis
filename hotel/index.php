        	...
        	<div class="container py-sm-4">
        		<div class="row">
        			<div class="col-lg-6 about-left mb-md-0 mb-5">
        				...
        				<a href="about.php" class="btn btn-style btn-primary mt-sm-5 mt-4">Sobre Nosotros</a>
        			</div>
                    ...
                    <div class="maghny-gd-1 col-lg-6">
                        <div class="maghny-grid">
                            ...
                            <div class="room-info">
                                ...
                                <a href="mis_reservas.php#booking" class="btn btn-style btn-primary mt-sm-4 mt-3">Reserva Ahora</a>
                            </div>
                        </div>
                    </div>
